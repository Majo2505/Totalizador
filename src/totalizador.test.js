...
describe("CalcularImpuestoCategoria", () => {
    ...
    it("deberia calcular 0% de impuesto adicional para Varios", () => {
        expect(calcularImpuestoCategoria(100, "Varios")).toEqual(0);
    });
});
...
describe("CalcularCostoEnvio - Validaciones", () => {
    ...
    it("deberia retornar 'Peso invalido' si el peso es menor a 0", () => {
...
describe("CalcularCostoEnvio - Rangos", () => {
    ...
    it("deberia calcular $3.5 por unidad de costo de envio para peso volumetrico entre 11 y 20", () => {
    ...
    it("deberia calcular $6.0 por unidad para peso de 41 a 80", () => {
        expect(calcularCostoEnvio(50, 1)).toEqual(6.0);
    });
    it("deberia calcular $6.5 por unidad para peso de 81 a 100", () => {
        expect(calcularCostoEnvio(90, 1)).toEqual(6.5);
    });
...
describe("CalcularDescuentoEnvioCliente", () => {
    ...
    it("deberia calcular 1.5% de descuento en el costo de envio para cliente Especial", () => {
